        ...
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-success text-light" data-toggle="modal" id="mediumButton" data-target="#mediumModal"
                   data-attr="{{ route('author.create') }}" title="Create a project"> <i class="fas fa-plus-circle"></i>
                </a>
            </div>
        </div>
    </div>
                ...
                <td>
                    <form action="{{ route('author.destroy', $author->author_id) }}" method="POST">
                        ...
                        <a data-toggle="modal" id="smallButton" data-target="#smallModal"
                           data-attr="{{ route('author.show', $author->author_id) }}" title="show">
                            <i class="fas fa-eye text-success  fa-lg"></i>
                        </a>

                        <a class="text-secondary" data-toggle="modal" id="mediumButton" data-target="#mediumModal"
                           data-attr="{{ route('author.edit', $author->author_id) }}">
